...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "KUKU MUSIC")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6003832175").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/KUKU-MUSICBOT/KUKU-MUSICBOT",
)
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @ANSH_MAKERBOT
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/57aba2aaa2a4c4521631c.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/415258d46fe154e1155bd.jpg",
)

PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "https://te.legra.ph/file/b3409fa167213f035ba6a.jpg",
)
